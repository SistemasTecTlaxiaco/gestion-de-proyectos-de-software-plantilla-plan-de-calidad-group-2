...
Las principales referencias utilizadas son CMMI, MoProSoft, ISO/IEC 25010
...
MoProSoft es un modelo mexicano de procesos para la industria de software.
...
ISO/IEC 25010 establece un modelo de calidad para productos de software.
...
El sistema debe comportarse de forma consistente.
...
Las funciones administrativas deben contar con controles de acceso.
...
WCAG 2.2 establece recomendaciones y criterios verificables para mejorar

la accesibilidad del contenido web.



Para este proyecto son relevantes aspectos como:
...
Por ello, la calidad debe considerar:
...
# 8. Calidad del contenido cultural
...
El equipo debe revisar las recomendaciones antes de incorporarlas al
...
Los modelos y referencias revisados permiten justificar la importancia de

prevenir errores antes de que lleguen a etapas posteriores.



Por ello se utiliza el indicador:
...
WCAG 2.2 permite incorporar criterios de accesibilidad.
...
&#x20;  https://dof.gob.mx/nota_detalle_popup.php?codigo=5453674
...
4\. World Wide Web Consortium. (2023).
...
El proyecto no afirma estar certificado en CMMI, MoProSoft, ISO/IEC 25010
